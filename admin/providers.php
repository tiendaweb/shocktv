    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-72 bg-[#07070a] border-r border-white/10 p-8 sticky top-0 h-screen overflow-y-auto">
            ...
            <nav class="space-y-3">
                ...
                <a href="/admin/providers" class="block px-4 py-3 bg-rose-600 text-white rounded-lg font-bold text-sm transition">
                        ...
                        <div class="bg-[#0a0a0f] rounded-xl border border-white/10 p-8 max-w-lg w-full">
                            ...
                            <form method="POST" class="space-y-4">
                                ...
                                <div class="flex gap-3 pt-4">
                                    ...
                                    <a href="/admin/providers" class="flex-1 bg-gray-700 hover:bg-gray-600 py-2 rounded font-bold transition text-center">
                                        Cancelar
                                    </a>
                                </div>
                            </form>
